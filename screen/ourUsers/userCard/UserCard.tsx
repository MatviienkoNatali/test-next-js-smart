...
function UserCard({ props }) {
    ...
    const online = props.status;
    return (
        <div className={styles.block}>
            <picture className={styles.photo}>
                <img src={url + props.photo} alt="mrSmith"/>
            </picture>
            ...
            <div className={`${styles.action} ${online ? styles.actionOnline : ''}`}>
                <button>
                    <p>Chat</p>
                    <svg className={styles.iconAction} width="22" height="19" viewBox="0 0 22 19" fill="none">
